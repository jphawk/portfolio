...
function WorkCase(props) {
  ...
  return (
    <div className='page'>
      {props.workcases
        .filter((workcase) => workcase.slug === slug)
        .map((filteredCase, key) => (
              ...
              <div className='page-workcase-container'>
                <ReactMarkdown
                  source={
                    ...
                    filteredCase.workcaseContentHtml.toString()
                  }
                  escapeHtml={false}
                />
                ...
                <div className='tags'>
                  {filteredCase.tags && (
                    <h3 style={{ color: props.bgcolor }}>
                      Stack, techniques and tools:
                    </h3>
                  )}
                  <ReactMarkdown
                    source={filteredCase.tags && filteredCase.tags.toString()}
                    escapeHtml={false}
                  />
                </div>
              </div>
