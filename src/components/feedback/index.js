    ...
    <div className='feedback-container container'>
      ...
      <Slider dots className={dots}>
        {feedback.map((myfeedback, key) => (
          <div key={key}>
            <p className='feedback-container-rec'>
              {myfeedback.recommendation}
            </p>
            <p className='feedback-container-info'>
              <a
                className='feedback-container-author'
                href={myfeedback.linkedin}
                title={myfeedback.author}
                style={{ color: bgcolor }}
                target='_blank'
              ...
              <a
                className='feedback-container-author'
                href={myfeedback.companyLink}
                title={myfeedback.company}
                target='_blank'
                rel='noopener noreferrer'
                style={{ color: bgcolor }}
              >
